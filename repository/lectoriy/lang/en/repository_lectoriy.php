...
/**
 * Strings for component 'repository_lectoriy', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['url'] = 'URL site';
$string['pluginname'] = 'Lectoriy videos';
$string['search'] = 'Search videos';
$string['lectoria:view'] = 'Use lectoriy in file picker';
$string['configplugin'] = 'lectoriy repository type configuration';
